...
\begin{subfigure}{.5\textwidth}
  ...
  \caption{Effect of changes in wet-bulb globe temperature on expressed sentiment relationship as moderated by neighborhood majority race.}
  \label{fig:sub2}
\end{subfigure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{../res/map_wbgt.png}
  \caption{Effects of rising temperatures on sentiment by Combined Statistical Areas (CSAs) with over 1 million people.  The value shown is the predicted change in vader score for a 25-degree increase in temperatures.  CSAs with a statistically significant effect ($p < 0.1$) are outlined in black.}
  \label{fig:map-wbgt}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{../res/map_wbgt_income.png}
  \caption{Expected gap in sentiment scores between poor and rich neighborhoods, by Combined Statistical Areas (CSAs) with over 1 million people.  The value shown is the predicted gap in vader scores for a 25-degree increase in temperatures between neighborhoods at the 5th percentile and the 90th percentile for income.  CSAs with a statistically significant effect ($p < 0.1$) are outlined in black.}
  \label{fig:map-wbgt-income}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{../res/map_wbgt_race.png}
  \caption{Expected gap in sentiment scores between largely minority and largely white neighborhoods, by Combined Statistical Areas (CSAs) with over 1 million people.  The value shown is the predicted gap in vader scores for a 25-degree increase in temperatures between neighborhoods at the 5th percentile and the 95th percentile for whiteness.  CSAs with a statistically significant effect ($p < 0.1$) are outlined in black.}
  \label{fig:map-wbgt-race}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{../res/ts_income.png}
  \caption{Expected gap in sentiment scores between largely minority and largely white neighborhoods, by hour of the day, with a 95\% confidence interval.  The value shown is the predicted gap in vader scores for a 25-degree increase in temperatures between neighborhoods at the 5th percentile and the 95th percentile for income.}
  \label{fig:map-wbgt-income}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\linewidth]{../res/ts_race.png}
  \caption{Expected gap in sentiment scores between largely minority and largely white neighborhoods, by hour of the day, with a 95\% confidence interval.  The value shown is the predicted gap in vader scores for a 25-degree increase in temperatures between neighborhoods at the 5th percentile and the 95th percentile for whiteness.}
  \label{fig:map-wbgt-race}
\end{figure}
