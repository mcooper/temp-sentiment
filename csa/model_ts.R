...
m$estimate <- 25*(m$estimate/(qs[2] - qs[20]))
m$std.error <- 25*(m$std.error/(qs[2] - qs[20]))
...
m$estimate <- 25*(m$estimate/(race_qs[2] - race_qs[20]))
m$std.error <- 25*(m$std.error/(race_qs[2] - race_qs[20]))
